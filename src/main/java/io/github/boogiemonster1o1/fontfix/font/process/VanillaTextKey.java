...
public class VanillaTextKey {
     ...
     * Copy constructor
     */
    private VanillaTextKey(@NotNull CharSequence str, int style, int hash) {
     ...
     */
    public void updateKey(CharSequence str, @NotNull Style style) {
        this.str = str;
     ...
     * @return result
     */
    public static int parseStyle(@NotNull Style style) {
    ...
    public int hashCode() {
        ...
        if (code == 0) {
            ...
            return this.hash = code * 31 + this.style;
        }
