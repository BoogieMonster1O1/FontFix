...
public class FormattingStyle {
    ...
    public FormattingStyle(int stringIndex, int stripIndex, Style style) {
        ...
        this.color = getColor(style);
        this.flags = getFlags(style);
    }

    public static int getColor(@NotNull Style style) {
        return style.getColor() == null ? NO_COLOR : style.getColor().getRgb();
    }
    ...
    public static byte getFlags(@NotNull Style style) {
        byte v = PLAIN;
        if (style.isBold()) {
            v |= BOLD;
        }
    ...
    public int getFontStyle() {
        return this.flags & FONT_STYLE_MASK;
    }
    ...
    public boolean isUnderline() {
        return (this.flags & UNDERLINE_MASK) != 0;
    }
    ...
    public boolean isStrikethrough() {
        return (this.flags & STRIKETHROUGH_MASK) != 0;
    }
    ...
    public boolean isObfuscated() {
        return (this.flags & OBFUSCATED_MASK) != 0;
    }
     ...
     */
    public boolean layoutStyleEquals(@NotNull FormattingStyle s) {
